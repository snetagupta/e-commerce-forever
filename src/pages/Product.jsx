    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <button onClick={()=>addToCart(productData._id,size)} className="bg-black text-white px-8 py-3 text-sm active:bg-gray-700 uppercase">
            Add to cart
          </button>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>
            ...
            products on online services or over the Internet. E-commerce draws
          ...
          <p>
            Marketing texts for regular pages: a home page, About Us, payment
            options, guarantees, FAQs, and contacts
          </p>
        </div>
      </div>
